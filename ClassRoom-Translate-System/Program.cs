...
namespace WindowsFormsApp1
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // python環境にパスを通す
            // TODO: 環境に合わせてパスを直すこと
            var PYTHON_HOME = Environment.ExpandEnvironmentVariables(@"C:\Users\shohe\Anaconda3\envs\pythonnet_test");
            ...
            PythonEngine.PythonPath = string.Join(
              ...
              new string[] {
                  ...
                  Path.Combine(@"C:\cs_source"), //自分で作った(動かしたい)pythonプログラムの置き場所も追加
              }
            );
            /*
